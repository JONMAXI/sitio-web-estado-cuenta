...
gcs_client = storage.Client()  # Asume que la cuenta de servicio de Cloud Run tiene permisos
...
# ------------------ PROCESAR ESTADO DE CUENTA ------------------
def procesar_estado_cuenta(estado_cuenta):
    # ... misma función que ya tenías, omito repetir por brevedad ...
    pass
...
@app.route('/', methods=['GET', 'POST'])
def index():
    # ... igual que antes, con auditoría incluida ...
    pass
